        ...
        <>
            <div className={`contacts ${props.theme === "dark" ? "dark" : ""}`}>
                ...
                <div className="contacts__info">
                    ...
                    <div className="contacts__info_tg">Telegram: <a href="https://t.me/gmbard" target="_blank" rel="noopener noreferrer">Написать в телеграм</a></div>
                    <div className="contacts__info_github">Github: <a href="https://github.com/S0MANY" target="_blank" rel="noopener noreferrer">Перейти на страницу Github</a></div>
                </div>
            </div>
        </>
    )
